...
@mark.parametrize('platform_name, distro_name, distro_version, result', [
    ...
    param('Linux', 'ubuntu', '14.04', 'linux-x86_64-ubuntu1404', marks=mark.xfail(raises=OSError, strict=True)),
    ...
    param('Linux', 'Debian', '8.0', 'linux-x86_64-debian80', marks=mark.xfail(raises=OSError, strict=True)),
    ('Linux', 'debian', '9.2', 'linux-x86_64-debian92'),
    ('Linux', 'debian', '10.0', 'linux-x86_64-debian10'),
    ('Linux', 'debian', '9.0', 'linux-x86_64-debian92'),
    param('Linux', 'opensuse', '8.0', 'linux-x86_64-opensuse80', marks=mark.xfail(raises=OSError, strict=True)),
    ('Darwin', '', '', 'macos-x86_64'),
